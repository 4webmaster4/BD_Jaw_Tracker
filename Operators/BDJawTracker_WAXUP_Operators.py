...
class BDJawTracker_OT_LowJawChild(bpy.types.Operator):
    """  Make LowJaw Child to LowMarker """

    bl_idname = "bdjawtracker.lowjawchildtolowmarker"
...
class BDJawTracker_OT_BakePlane(bpy.types.Operator):
    """ Will create and bake occlusal plane or planes"""

    bl_idname = "bdjawtracker.bakeplane"
    ...
    def bakeUpPlane(self):
        ...
        bpy.ops.object.select_all(action='DESELECT')
        bpy.ops.object.empty_add(type='PLAIN_AXES', align='WORLD', location=(0, 0, 0), scale=(10, 10, 10))
...
classes = [
    BDJawTracker_OT_BakePlane,
    BDJawTracker_OT_LowJawChild,
]
